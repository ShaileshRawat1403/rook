...
use rook::agents::mcp_client::{Error as McpError, McpClientTrait};
use rook::agents::platform_extensions::developer::edit::{
    resolve_path, string_replace, FileEditParams, FileReadParams, FileWriteParams,
};
use rook::agents::platform_extensions::developer::shell::{ShellParams, OUTPUT_LIMIT_BYTES};
...
impl AcpTools {
    fn update_tool_call(&self, ctx: &rook::agents::ToolCallContext, fields: ToolCallUpdateFields) {
    ...
    async fn acp_read(
        &self,
        arguments: Option<rmcp::model::JsonObject>,
        ctx: &rook::agents::ToolCallContext,
