...
impl ComputerControllerServer {
    pub fn new() -> Self {
        ...
        // - macOS/Linux: ~/.cache/rook/computer_controller/
        // - Windows:     ~\AppData\Local\Block\rook\cache\computer_controller\
        ...
        Self {
            ...
            http_client: Client::builder().user_agent("rook/1.0").build().unwrap(),
            instructions,
            system_automation,
            #[cfg(target_os = "macos")]
