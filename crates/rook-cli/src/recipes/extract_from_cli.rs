...
use rook::recipe::{Recipe, SubRecipe};
...
mod tests {
    ...
    fn test_extract_recipe_info_from_cli_basic() {
        ...
        assert_eq!(settings.rook_provider, Some("test_provider".to_string()));
        assert_eq!(settings.rook_model, Some("test_model".to_string()));
