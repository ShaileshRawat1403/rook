...
static TEMPLATE_REGISTRY: &[(&str, &str)] = &[
    (
        "system.md",
        "Main system prompt that defines Rook's personality and behavior",
    ),
    (
        "compaction.md",
    ...
    (
        "apps_create.md",
        "Prompt for generating new Rook apps based on the user instructions",
    ),
    (
        "apps_iterate.md",
        "Prompt for updating existing Rook apps based on feedback",
    ),
    (
        "permission_judge.md",
    ...
    (
        "plan.md",
        "Prompt used when Rook creates step-by-step plans. CLI only",
    ),
    (
