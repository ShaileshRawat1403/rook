...
use crate::oauth::persist::RookCredentialStore;

const CALLBACK_TEMPLATE: &str = include_str!("oauth_callback.html");
const CLIENT_METADATA_URL: &str = "https://rook-docs.ai/oauth/client-metadata.json";
...
pub async fn oauth_flow(
    ...
    let credential_store = RookCredentialStore::new(name.clone());
