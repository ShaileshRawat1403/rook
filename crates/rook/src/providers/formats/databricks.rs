...
pub fn create_request(
    ...
    if model_config.model_name.starts_with("o1-mini") {
        return Err(anyhow!(
            "o1-mini model is not currently supported since rook uses tool calling and o1-mini does not support it. Please use o1 or o3 models instead."
        ));
    }
...
mod tests {
    ...
    fn test_is_claude_model() {
        ...
        assert!(is_claude_model("rook-claude-sonnet"));
