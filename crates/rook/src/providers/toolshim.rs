...
/// - ROOK_TOOLSHIM: When set to "true" or "1", enables using the tool shim in the standard OllamaProvider (default: false)
/// - ROOK_TOOLSHIM_OLLAMA_MODEL: Ollama model to use as the tool interpreter (default: DEFAULT_INTERPRETER_MODEL)
...
";
        ...
        let interpreter_model = std::env::var("ROOK_TOOLSHIM_OLLAMA_MODEL")
