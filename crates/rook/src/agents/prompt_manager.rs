...
impl<'a> SystemPromptBuilder<'a, PromptManager> {
    ...
    pub fn with_rook_mode(mut self, mode: RookMode) -> Self {
    ...
    pub fn build(self) -> String {
        ...
        let rook_mode = self
            .rook_mode
            .unwrap_or_else(|| Config::global().get_rook_mode().unwrap_or_default());
        ...
        let context = SystemPromptContext {
            ...
            rook_mode,
            is_autonomous: rook_mode == RookMode::Auto,
        ...
        .unwrap_or_else(|_| {
            "You are a general-purpose AI agent called Rook, created by Block".to_string()
        });
