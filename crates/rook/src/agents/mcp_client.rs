...
/// MCP client implementation for Rook
use rmcp::{
    model::{
...
impl ClientHandler for RookClient {
    async fn list_roots(
        &self,
    ...
    async fn create_message(
        ...
        let system_prompt = params
            .system_prompt
            .as_deref()
            .unwrap_or("You are a general-purpose AI agent called rook");
    ...
    fn get_info(&self) -> ClientInfo {
        ...
        InitializeRequestParams::new(
            ...
            Implementation::new(
                ...
                std::env::var("ROOK_MCP_CLIENT_VERSION")
...
#[derive(Debug, Clone)]
pub struct RookMcpClientCapabilities {
    pub mcpui: bool,
}

/// The MCP client is the interface for MCP operations.
pub struct McpClient {
    client: Mutex<RunningService<RoleClient, RookClient>>,
...
impl McpClient {
        ...
        E: std::error::Error + From<std::io::Error> + Send + Sync + 'static,
    {
        ...
        let client: rmcp::service::RunningService<rmcp::RoleClient, RookClient> =
...
mod tests {
    use super::*;
    use crate::agents::RookPlatform;
    use serde_json::json;
    use test_case::test_case;

    fn new_client(platform: RookPlatform) -> RookClient {
        let capabilities = match platform {
            RookPlatform::RookDesktop => RookMcpClientCapabilities { mcpui: true },
            RookPlatform::RookCli => RookMcpClientCapabilities { mcpui: false },
        };
    ...
    fn test_resolve_session_id(
        ...
        runtime.block_on(async {
            let client = new_client(RookPlatform::RookCli);
    ...
    fn test_request_injects_session(request_builder: fn(Extensions) -> ClientRequest) {
        ...
        extensions.insert(
            serde_json::from_value::<Meta>(json!({
                "Rook-Session-Id": "old-session-id",
    ...
    fn test_client_info_advertises_mcp_apps_ui_extension() {
        let client = new_client(RookPlatform::RookDesktop);
