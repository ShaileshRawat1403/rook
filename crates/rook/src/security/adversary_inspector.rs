...
///
/// Activated by placing an `adversary.md` file in the Rook config directory
/// (`~/.config/rook/adversary.md`). The file contains optional frontmatter
...
mod tests {
    ...
    async fn test_disabled_when_no_adversary_md() {
        ...
        let results = inspector
            .inspect("test", &[request], &[], RookMode::Auto)
            .await
            .unwrap();
