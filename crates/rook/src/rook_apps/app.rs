...
impl RookApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-rook-prd";
    const ROOK_APP_TYPE: &'static str = "RookApp";
    const ROOK_SCHEMA_CONTEXT: &'static str = "urn:rook.ai:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No RookApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::ROOK_SCHEMA_CONTEXT,
            "@type": Self::ROOK_APP_TYPE,
