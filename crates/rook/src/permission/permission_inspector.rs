...
use crate::config::{PermissionManager, RookMode};
    ...
    async fn inspect(
        ...
        for request in tool_requests {
            if let Ok(tool_call) = &request.tool_call {
                ...
                let action = match rook_mode {
                    RookMode::Chat => continue,
                    RookMode::Auto => InspectionAction::Allow,
                    RookMode::Approve | RookMode::SmartApprove => {
                        ...
                        // 2. Check if it's a smart-approved tool (annotation or cached LLM decision)
                            ...
                            || (rook_mode == RookMode::SmartApprove
...
mod tests {
    ...
    #[test_case(RookMode::Auto, false, None, InspectionAction::Allow; "auto_allows")]
    #[test_case(RookMode::SmartApprove, true, None, InspectionAction::Allow; "smart_approve_annotation_allows")]
    #[test_case(RookMode::SmartApprove, false, Some(PermissionLevel::AlwaysAllow), InspectionAction::Allow; "smart_approve_cached_allow")]
    #[test_case(RookMode::SmartApprove, false, Some(PermissionLevel::AskBefore), InspectionAction::RequireApproval(None); "smart_approve_cached_ask")]
    #[test_case(RookMode::SmartApprove, false, None, InspectionAction::RequireApproval(None); "smart_approve_unknown_defers")]
    #[test_case(RookMode::Approve, false, None, InspectionAction::RequireApproval(None); "approve_requires_approval")]
    #[test_case(RookMode::Approve, false, Some(PermissionLevel::AlwaysAllow), InspectionAction::RequireApproval(None); "approve_ignores_cache")]
    #[tokio::test]
    async fn test_inspect_action(
        ...
        let results = inspector
            .inspect(rook_test_support::TEST_SESSION_ID, &[req], &[], mode)
            .await
            .unwrap();
