...
Rook's canonical terminal UI lives in `crates/rook-cli` and uses Ratatui (Rust).

The legacy Ink-based `ui/text` package has been removed. Do not add new terminal UI work under `ui/text`.
