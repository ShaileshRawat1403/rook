...
vi.mock("@/features/providers/hooks/useAgentProviderStatus", () => ({
  useAgentProviderStatus: () => ({
    readyAgentIds: new Set(["rook", "claude-acp", "codex-acp"]),
    loading: false,
    refresh: vi.fn(),
  }),
}));
...
describe("ChatInput", () => {
  ...
  it("renders with default placeholder", () => {
    ...
    expect(
      screen.getByPlaceholderText("Message Rook, @ to mention personas"),
    ).toBeInTheDocument();
  });
  ...
  it("shows default provider label", () => {
    ...
    expect(providerButton).toHaveTextContent("Rook");
  });
  ...
  it("shows project files in @mention results and inserts the selected path", async () => {
    const user = userEvent.setup();
    mockListFilesForMentions.mockResolvedValue([
      "/Users/wesb/dev/rook/README.md",
      "/Users/wesb/dev/rook/src/features/chat/ui/ChatInput.tsx",
    ]);
    ...
    expect(input).toHaveValue("/Users/wesb/dev/rook/README.md ");
  });
