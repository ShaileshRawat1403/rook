...
const ACP_SESSION_METADATA_STORAGE_KEY = "rook:acp-session-metadata";
const DRAFT_SESSION_STORAGE_KEY = "rook:chat-draft-sessions";
const LEGACY_SESSION_CACHE_STORAGE_KEY = "rook:chat-sessions";
const DRAFT_TEXT_STORAGE_KEY = "rook:chat-drafts";
