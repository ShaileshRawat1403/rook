...
export const PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  ...
  {
    id: "gemini_oauth",
    displayName: "Google Gemini (Pro/Plus)",
    category: "model",
    description: "Gemini via Google subscription",
    setupMethod: "oauth_browser",
    nativeConnectQuery: "Google Gemini (Pro/Plus)",
    tier: "promoted",
  ...
  },
  {
    ...
    category: "model",
    description: "Gemini CLI with OAuth",
    setupMethod: "oauth_browser",
    nativeConnectQuery: "Gemini CLI",
    tier: "standard",
    docsUrl: "https://github.com/Augustin000/Claude-gemini-cli",
  },
  {
    id: "chatgpt_codex",
