...
export function ThemeProvider({
  ...
  const [theme, setThemeState] = React.useState<ThemePreference>(() => {
    const stored = localStorage.getItem("rook-theme") as ThemePreference | null;
