...
use crate::services::rook_config::RookConfig;
...
#[tauri::command]
pub fn list_extensions(config: State<'_, RookConfig>) -> Result<Vec<Value>, String> {
...
#[tauri::command]
pub fn remove_extension(config_key: String, config: State<'_, RookConfig>) -> Result<(), String> {
    let mut raw = config.get_extensions_raw();
