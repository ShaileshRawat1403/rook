# rook Release Manual Testing Checklist
...
- [ ] Launch rook, click reset providers, choose databricks and a model
...
- [ ] Create a file `~/.config/rook/recipes/test-recipe.yaml` with the following content:
...
- [ ] Can manually add a custom stdio MCP extension and chat with it
  - [ ] Use any local MCP stdio server you have available
  - [ ] Verify the extension registers and responds to a request
...
- [ ] Install an extension from deeplink that needs env variables:
  - [ ] Use: `rook://extension?cmd=npx&arg=-y&arg=%40upstash%2Fcontext7-mcp&id=context7&name=Context7&description=Use%20up-to-date%20code%20and%20docs&env=TEST_ACCESS_TOKEN`
