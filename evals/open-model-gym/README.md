...
- `goose` — [Goose](https://github.com/aaif-rook/rook) agent framework
...
[Goose](https://github.com/aaif-rook/rook) is an open-source coding agent with built-in MCP support.
