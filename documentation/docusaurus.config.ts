...
const config: Config = {
  title: "rook | Your open source AI agent",
  tagline: "terminal-native AI agency with coordinated tools and governance",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://rook-docs.ai/",
  ...
  organizationName: "ShaileshRawat1403", // Usually your GitHub org/user name.
  projectName: "rook", // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      title: "",
      logo: {
        alt: "rook Logo", // TODO: replace logo assets with final Rook branding
      ...
      items: [
        ...
        {
          href: "https://github.com/ShaileshRawat1403/rook",
          label: "GitHub",
          position: "right",
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "YouTube",
              href: "https://www.youtube.com/@rook-oss",
            },
            {
              label: "LinkedIn",
              href: "https://www.linkedin.com/company/rook-oss",
            },
            {
              label: "Twitter / X",
    ...
    inkeepConfig: {
      ...
      aiChatSettings: {
        chatSubjectName: "rook",
        botAvatarSrcUrl: "",
        getHelpCallToActions: [
          {
            name: "GitHub",
            url: "https://github.com/ShaileshRawat1403/rook",
            icon: {
              builtIn: "FaGithub",
            },
          },
        ],
        quickQuestions: ["What is rook?"],
      },
    },
    announcementBar: {
