...
rook is designed to be forked and customized. You can create your own "distro" of rook preconfigured with specific providers, bundled extensions, custom branding, and tailored workflows for your organization or audience.
...
## Quick example: ship rook with a local model
