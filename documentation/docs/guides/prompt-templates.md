...
rook comes with built-in prompt templates that guide its behavior in different situations. You can edit these templates to customize how rook responds, creates plans, decides what to save during compaction, and more.
...
- Your customizations persist across rook updates
...
- Edit `system.md` to have rook respond in Dutch by adding an instruction to "Reply in Dutch"
...
<Tabs groupId="interface">
  ...
  rook Desktop users can manage templates from the `Settings` page.
  ...
  **To reset a template to its default:**
  ...
  rook CLI users can edit template files directly in the file system.
