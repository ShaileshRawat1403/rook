...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Complete technical reference for creating and customizing recipes in rook via the CLI."
    ...
    />
    <Card 
      title="rook Recipes Tutorial"
      description="Learn how to create and use rook recipes with prompts, parameters, MCP servers, and more."
    ...
    <Card 
      ...
      description="Learn how to save, organize, and find your rook recipes for easy access and reuse."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Interactive tool that creates a shareable rook recipe URL that others can use to launch a session with your predefined settings."
...
<VideoCarousel
  ...
  videos={[
    { 
      ...
      title: 'Advanced Tips for Recipes/Subrecipes in rook',
      description: 'Advanced tips for using recipes and subrecipes in rook',
      duration: '10:07'
    },
    { 
      type: 'iframe', 
      src: 'https://youtube.com/embed/gvg7DomaJuA',
      title: 'Headless rook, Scheduling a Parallel-Subagent Recipe',
