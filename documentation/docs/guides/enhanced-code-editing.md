...
1. **Configuration Check**: rook checks if all three environment variables are properly set and non-empty.

2. **With AI Enabled**: If configured, rook sends the original code and your requested change to the configured AI model for processing.
