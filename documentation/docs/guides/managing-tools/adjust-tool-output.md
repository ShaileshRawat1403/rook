...
Response Styles customize how tool interactions are displayed in the rook Desktop chat window. 
...
- **Concise** (Default)
    ...
    - Shows only which tool rook used
...
- **Detailed**
    ...
    - Best for debugging or learning how rook works
...
When working with the rook CLI, you can control the verbosity of tool output.
