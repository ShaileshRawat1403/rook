---
title: Staying Safe with rook
hide_title: true
description: Keep your rook workflows safe with built-in security features and best practices
---

import Card from '@site/src/components/Card';
import styles from '@site/src/components/Card/styles.module.css';

<h1 className={styles.pageTitle}>Staying Safe with rook</h1>
<p className={styles.pageDescription}>
  Understanding security risks and following best practices can help you secure your workflows with rook.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Control file access, network connections, and process restrictions for rook Desktop using Apple's sandbox technology."
