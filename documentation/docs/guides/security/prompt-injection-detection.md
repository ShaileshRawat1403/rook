...
5. **You choose** whether to proceed or cancel after reviewing the alert details. Note that:
   - Each decision is logged with its finding ID in the [rook system logs](/docs/guides/logs#system-logs)
...
<Tabs groupId="interface">
  ...
  <TabItem value="config" label="rook config file">
...
Beyond prompt injection detection, rook automatically:
