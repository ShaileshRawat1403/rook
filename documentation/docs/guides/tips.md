...
### Control which extensions rook can use
Administrators can use an [allowlist](/docs/guides/allowlist) to restrict rook to approved extensions only. This helps prevent risky installs from unknown MCP servers.
