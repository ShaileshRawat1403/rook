...
description: "Create custom shortcuts to quickly apply reusable instructions in any rook chat session"
---
...
<Tabs groupId="interface">
  ...
  The command appears under the recipe in your `Recipes` menu. For recipes that aren't in your Recipe Library, follow the `rook CLI` steps.
...
Typing `/` in rook Desktop shows a popup menu with the available slash commands.
:::
  ...
  items={[
    {
      type: 'topic',
      title: 'Recipes',
      description: 'Check out the Recipes guide for more docs, tools, and resources to help you master rook recipes.',
