...
description: Chat with rook through Telegram from any device.
---

The Telegram Gateway lets you interact with rook through Telegram, enabling remote access from any device where Telegram is available.
...
You can now chat with rook through Telegram!
...
rook gateway start telegram --bot-token YOUR_BOT_TOKEN

# Generate a pairing code
rook gateway pair telegram

# Stop the gateway
rook gateway stop telegram
```

## What You Can Do

Once paired, you can:
- Send messages to rook and receive responses
- Get formatted code blocks with syntax highlighting
- Continue conversations across multiple sessions
- Access all your configured rook extensions
...
- Check that the gateway is running in rook Desktop
- Ensure your computer is awake and rook Desktop is open
