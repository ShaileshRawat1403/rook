...
<p className={styles.pageDescription}>
  rook is an open source project that is constantly being improved and expanded upon. These experimental features and projects are still in development and may not be fully stable or ready for production use, but they showcase exciting possibilities for the future of AI automation.
</p>

:::note
The list of experimental features may change as rook development progresses. Some features may be promoted to stable features, while others might be modified or removed. This section will be updated with specific experimental features as they become available.
:::
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      title="Remote Access"
      description="Access rook remotely via the rook AI mobile app or messaging platforms like Telegram."
      link="/docs/experimental/remote-access"
    />
    <Card 
      title="rook for VS Code Extension"
      description="Interact with rook directly from VS Code via ACP."
      link="/docs/experimental/vs-code-extension"
    />
    <Card 
      title="Using rook in ACP Clients"
      description="Interact with rook natively in ACP-compatible clients like Zed."
