...
Let's start by having a brainstorming conversation with rook to clarify our requirements.
...
Now that we've clarified the requirements, let's ask rook to create a comprehensive plan.
...
rook will generate a comprehensive plan similar to this:
...
Now let's ask rook to create the specific implementation prompt that will guide the execution.

### Creating the Implementation Prompt

**You:**  _"This plan looks comprehensive! Can you now create a detailed implementation prompt that I can use to execute this plan? I want something specific enough that rook can follow it step-by-step without needing additional clarification."_

### The Implementation Prompt

rook will generate a detailed prompt like this:
...
rook will now work through each step of the plan, creating the necessary files and configurations.

### Monitoring Progress

As rook implements the plan, you can verify each deliverable against the checklist we created:
...
3. Ask rook to identify potential issues and provide mitigation strategies.
...
### Dependency Mapping
Ask rook to identify dependencies between tasks:
...
The key is treating rook as a planning partner, not just a code generator. Give it the full context of what you're trying to achieve, and let it help you think through the complexity before diving into implementation.
