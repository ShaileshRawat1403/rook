...
description: Create your own custom MCP Server to use as a rook extension
---
...
2. Open rook Desktop and click the <PanelLeft className="inline" size={16} /> button in the top-left to open the sidebar
...
![rook Chat - Ask about tools](../assets/guides/custom-extension-tools.png)
...
rook supports advanced MCP features that can enhance your extensions.
...
- Components render securely in isolated sandboxes within rook Desktop
...
:::note
rook also supports [MCP-UI](/docs/guides/interactive-chat/mcp-ui), but MCP Apps is the recommended path for new extensions.
:::
