---
description: Integrate rook with MLflow to observe and evaluate agent performance
---

# Observability with MLflow

This tutorial covers how to integrate rook with MLflow to trace your rook sessions and understand how the agent is performing.
...
## Configure rook to export OTLP to MLflow

rook exports OpenTelemetry data over OTLP/HTTP. Point the exporter to MLflow's OTLP endpoint:
...
## Run rook with MLflow enabled

Start rook normally. With the OTLP environment variables set, rook will automatically export traces to MLflow:
