...
While the basic [Cognee MCP setup](../mcp/cognee-mcp.md) gets you started, this tutorial explores how to make rook autonomously use the knowledge graph and optimize your workflow.
...
This advanced usage guide should help you maximize the potential of Cognee with rook for sophisticated knowledge management and automation workflows.
