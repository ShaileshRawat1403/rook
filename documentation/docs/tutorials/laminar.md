---
description: Integrate rook with Laminar to observe performance
---

# Observability with Laminar

This tutorial covers how to integrate rook with Laminar to trace your rook sessions and understand how the agent is performing.
...
## Configure rook to export OTLP to Laminar

rook exports OpenTelemetry data over OTLP/HTTP. Point the exporter to Laminar and provide your API key as an authorization header.
...
## Run rook with Laminar enabled

Start rook normally. With the OTLP environment variables set, Laminar will capture traces of your rook sessions and tool execution.

_[Example trace (public) in Laminar](https://laminar.sh/shared/traces/63010af0-cf31-b8b6-0d77-fc9924bcaa4c)_

![rook trace in Laminar](../assets/guides/laminar.png)
