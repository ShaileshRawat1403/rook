...
Simply mention in your conversation with rook that you want to work in an isolated environment:
...
1. Start a conversation with rook about a new feature
2. Request isolated development environment
3. rook creates branch and container
4. Develop and test the feature
5. If successful, merge the branch; if not, discard it

### Dependency Exploration

1. Ask rook to explore a new library or tool
