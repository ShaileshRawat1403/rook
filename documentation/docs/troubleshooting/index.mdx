...
hide_title: true
description: Get help, report issues, and troubleshoot common problems with rook.
---
...
<p className={styles.pageDescription}>
  Get help when you need it, report bugs, request features, and find solutions to common issues. rook provides built-in diagnostics and direct links to our support channels.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      title="Logs"
      description="Learn how to access and interpret rook session logs and system logs for debugging and troubleshooting purposes."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card 
      ...
      description="Join our active Discord server for real-time help, discussions, and community support from rook users and maintainers."
    ...
    <Card 
      ...
      link="https://github.com/ShaileshRawat1403/rook/issues"
    />
  </div>
</div>
