...
description: Add Google Drive MCP Server as a rook Extension
unlisted: true
---
...
This tutorial covers how to add the [Google Drive MCP Server](https://www.pulsemcp.com/servers/modelcontextprotocol-gdrive) as a rook extension, allowing you to list, read, and search files in Google Drive.
...
In this example, I’ll use rook to quickly gather and summarize important information for my upcoming marketing budget review meeting in 30 minutes. I’ll ask rook to find relevant documents from my Google Drive, summarize Q1 performance, highlight critical decisions on marketing automation and video production, and identify any outstanding action items from our last meeting.
