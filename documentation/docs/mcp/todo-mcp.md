...
description: Breaks complex work into trackable steps to help rook stay organized
---
...
rook automatically knows to use the Todo extension for tasks involving multiple files/components or uncertain scope. At the start of the task, rook will create an internal checklist, read and update progress as it works, and verify that all tasks are completed.

:::tip
You can ask rook to "show me the current todo list" at any time to see what's being tracked.
:::
...
In this example, I'm going to have rook help me fix formatting inconsistencies in documentation files. This demonstrates how the Todo extension helps rook stay organized when working through systematic improvements.
