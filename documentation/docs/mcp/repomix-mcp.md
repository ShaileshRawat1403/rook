...
description: Add Repomix MCP Server as a rook Extension
---
...
In this example, I’ll show you how to use rook with the Repomix Extension to analyze the compressed Axios repository. rook will focus on the `lib/core/Axios.js` file, explain its role in the architecture, spot missing tests, write new unit tests, and suggest improvements to the testing strategy and code maintainability. 

By compressing the entire codebase into an AI-friendly format, Repomix helps rook stay within token limits while providing detailed, file-specific insights.
