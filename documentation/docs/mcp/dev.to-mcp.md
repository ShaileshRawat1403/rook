...
description: Add Dev.to MCP Server as a rook Extension
---
...
This tutorial covers how to add the [Dev.to MCP Server](https://github.com/nickytonline/dev-to-mcp) as a rook extension to enable access to the Dev.to public API. With this extension, rook can fetch articles, tags, user info, comments, and more—without requiring authentication.
...
In this example, rook uses the `Dev.to MCP` extension to fetch the 5 most recent JavaScript articles and instantly turn them into a personalized learning hub.
