...
description: Add Cognee MCP Server as a rook Extension
---
...
This tutorial covers how to add the [Cognee MCP Server](https://github.com/topoteretes/cognee/tree/main/cognee-mcp) as a rook extension to enable knowledge graph memory capabilities, connecting to over 30 data sources for enhanced context and retrieval.
