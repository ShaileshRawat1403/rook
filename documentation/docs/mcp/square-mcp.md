...
description: Add the Square API as a rook Extension
---
...
<Tabs groupId="remote-or-local">
  ...
  <Tabs groupId="interface">
    ...
    <TabItem value="cli" label="rook CLI">
      ...
      When you start the next session, rook will open a browser where you can grant permissions and sign in to your Square account.
