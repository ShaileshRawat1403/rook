...
description: Use Computer Controller MCP Server as a rook Extension
---
...
This tutorial covers enabling and using the Computer Controller MCP Server, which is a built-in rook extension.

:::tip
Let rook complete its tasks without interruption - avoid using your mouse or keyboard until it's done.
:::
...
In this example, I'll show you how rook can multitask, handling everything from system controls and music playback to web research and data organization.
