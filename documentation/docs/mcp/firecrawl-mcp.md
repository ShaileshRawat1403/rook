...
description: Add Firecrawl MCP Server as a rook Extension
---
...
This tutorial will get you started with the [Firecrawl MCP Server](https://github.com/firecrawl/firecrawl-mcp-server) as a rook extension to enable powerful web scraping, crawling, and search capabilities for AI agents.
