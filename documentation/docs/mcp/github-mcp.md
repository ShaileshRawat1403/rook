...
description: Add GitHub MCP Server as a rook Extension
---
...
This tutorial covers how to add the [GitHub MCP Server](https://github.com/github/github-mcp-server) as a rook extension to enable file operations, repository management, search functionality, and more.
