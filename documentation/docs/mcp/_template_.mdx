...
description: Add {Extension Name} MCP Server as a rook Extension
---
...
This tutorial covers how to add the [{Extension Name} MCP Server](/) as a rook extension to enable ________________.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="rook Desktop" default>
  [Launch the installer]({rook_url})
  </TabItem>
