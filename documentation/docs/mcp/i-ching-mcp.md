...
description: Add I Ching MCP Server as a rook Extension
---

This tutorial covers how to add the [I Ching MCP Server](https://github.com/threemachines/i-ching) as a rook extension to enable traditional I Ching divination readings.

:::tip Quick Install
1. Install: `cargo install i-ching`
2. Configure: [Add I Ching Extension](rook://extension?cmd=i-ching-mcp-server&id=i-ching&name=I%20Ching&description=I%20Ching%20divination%20readings)
:::
...
:::tip Use rook to Help!
If you're unsure about any of these steps, you can ask rook to help you check your system and guide you through the Rust installation process.
:::
...
Then click the link above to configure it in rook.
