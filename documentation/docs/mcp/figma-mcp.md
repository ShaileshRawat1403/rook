...
description: Add Figma Dev Mode MCP Server as a rook Extension
---
...
The Figma extension in rook works alongside the Figma desktop app. You can use the extension to:
...
:::tip
You can provide rook with a Figma link or simply select an element in the Figma desktop app.
:::
