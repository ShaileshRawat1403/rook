...
Custom apps are single-file HTML applications with JavaScript, CSS, and HTML (no external dependencies or npm packages). They're exposed as [MCP App resources](/docs/guides/interactive-chat/mcp-ui) that run in standalone, sandboxed windows that you can launch from the `Apps` page or by asking rook in chat.
...
Let's ask rook to create a utility app.
...
The first iteration of my app looks and works great, but you can just ask rook to add features, change the styling, and more!
