...
description: Search conversation history and load session summaries across all your rook sessions
---
...
rook automatically uses Chat Recall when you reference past work or ask questions that require historical context.
...
:::info
Compacted sessions from rook versions prior to v1.14.0 may not be searchable due to a change in how conversation history is stored.
:::
