...
description: Use Container-Use MCP as a rook Extension
---
...
This tutorial covers how to add the [Container Use MCP Server](https://container-use.com) as a rook extension enabling rook to work in an isolated environment.
