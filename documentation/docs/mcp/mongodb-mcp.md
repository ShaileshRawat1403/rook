...
description: Add MongoDB MCP Server as a rook Extension
---
...
Just describe what you want to accomplish in natural language, and rook will help you execute the appropriate MongoDB operations safely and efficiently.
