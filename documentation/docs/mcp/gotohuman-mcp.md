...
description: Add gotoHuman MCP Server as a rook Extension
---
...
This tutorial covers how to add the [gotoHuman MCP Server](https://github.com/gotohuman/gotohuman-mcp-server) as a rook extension to bring **human-in-the-loop approvals** into your AI workflows. With gotoHuman, rook can pause and request a review before continuing, perfect for blog drafts, code reviews,compliance checks, etc.  
...
In this example, rook sends a LinkedIn post draft to gotoHuman for approval using the `n8n news to post` template that was created.
...
It connects to MCP servers like gotoHuman to extend its abilities. While rook can automate tasks, 
...
Once approved, rook can continue where it left off. 
...
Perfect! I've successfully sent your rook blog draft to gotoHuman for review using your "n8n news to post" form. Here's what was submitted:
