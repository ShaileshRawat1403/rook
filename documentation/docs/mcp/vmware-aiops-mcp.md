...
description: Add vmware-aiops MCP Server as a rook Extension for natural language VMware vCenter/ESXi operations
---
...
In this example, I'll use rook to perform a daily health check across my vCenter environment and remediate a disk space issue on a VM — all via natural language.
