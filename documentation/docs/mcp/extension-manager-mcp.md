...
description: Dynamically discover, enable, and disable extensions during rook sessions
---
...
Simply describe your task, and rook will handle the extension management automatically.
...
rook can work with many extensions, but having too many enabled at once can:
...
This creates a more focused, efficient experience where rook has access to exactly the tools it needs, when it needs them.
