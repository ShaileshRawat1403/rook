...
description: Use VS Code MCP Server as a rook Extension for file operations and VS Code integration
unlisted: true
---
...
This tutorial covers how to add the [VS Code MCP Server](https://github.com/block/vscode-mcp) as a rook extension to enable VS Code integration, file operations, and development workflow management.
...
The VS Code MCP extension enables rook to interact with your VS Code environment, managing files, projects, and development workflows. 
...
:::note
Every time you start a rook session with the VS Code MCP server enabled, it checks to see if a matching project is open in VS Code. If not, it will prompt you to open the project before proceeding.
:::
...
![session showing rook making updates and VS Code prompting user to accept or reject changes](../assets/guides/vscode-mcp.png)
