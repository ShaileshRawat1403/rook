---
title: rook Docs Extension

description: Add rook Docs MCP Server as a rook Extension
---
...
This tutorial covers how to add the [rook Docs MCP Server](https://github.com/idosal/git-mcp) as a rook extension to enable rook to answer questions about itself.
...
## Example Usage
GitMCP allows you to convert any Git repository into a rook extension. The rook Docs MCP Server is a great example of this, as it provides a way for rook to answer questions about itself.

Let's ask rook to create a recipe for us! It will use the rook Docs MCP Server to find the relevant information.
...
Please research the recipe format first using the rook Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions. 
...
Perfect! I've created a comprehensive automated code review recipe based on the rook documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
rook run automated-code-review.yaml \
...
- Proper YAML structure following rook recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "rook automated code review"
          language:
            type: string
