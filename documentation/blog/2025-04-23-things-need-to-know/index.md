...
Curious how other models stack up? Check out the [Community-Inspired Benchmark Leaderboard](https://rook-docs.ai/blog/2025/03/31/rook-benchmark/#leaderboard) to see how your favorite model performs with Goose.

And if you’re still deciding, here’s the full list of [available LLM providers](https://rook-docs.ai/docs/getting-started/providers#available-providers).
...
To help you manage this, there is a [Handling Rate Limits Guide](https://rook-docs.ai/docs/guides/handling-llm-rate-limits-with-rook/) that you can check out. 
...
Goose has an entire community behind it—folks building, exploring, breaking things (and fixing them), and sharing everything they learn along the way. We hang out on [Discord](https://discord.gg/rook-oss), we answer questions in [GitHub Discussions](https://github.com/aaif-rook/rook/discussions), and we host livestreams every week to show off what Goose can do and how to make it do more.
...
You’ll find those livestreams on our [YouTube channel](https://www.youtube.com/@rook-oss/streams), and upcoming ones on the Discord calendar. Plus, if you prefer documentation, the [Goose docs](https://rook-docs.ai/) and [blog](https://rook-docs.ai/blog) are constantly being updated with new guides, tips, and tutorials.
...
Now, head over to the [Quickstart Guide](https://rook-docs.ai/docs/quickstart) and get started.  

Oh and when you get to the [Tic-Tac-Toe game](https://rook-docs.ai/docs/quickstart/#write-prompt), I’ll bet you 10 Goosebucks you won’t beat the bot. 
...
<head>
  ...
  <meta property="og:url" content="https://rook-docs.ai/blog/2025/04/23/things-need-to-know" />
  ...
  <meta property="og:image" content="https://rook-docs.ai/assets/images/cover-2ba7c2e15786be2db6108c91d27dc1ec.png" />
  ...
  <meta name="twitter:image" content="https://rook-docs.ai/assets/images/cover-2ba7c2e15786be2db6108c91d27dc1ec.png" />
</head>