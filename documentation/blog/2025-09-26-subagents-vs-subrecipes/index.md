---
title: "How to Choose Between Subagents and Subrecipes in rook"
...
When you're working on complex projects with rook, you'll often need to break work into multiple tasks and run them with AI agents. Goose gives you two powerful ways to do this: [subagents](/docs/guides/subagents/) and [subrecipes](/docs/tutorials/subrecipes-in-parallel/). Both can run multiple AI instances in parallel, but they work  differently. Picking which one to use can be confusing, so we're going to guide you to a decision.
...
Subagents excel when you're in a rook session and just want task delegation without setup overhead. Here's how simple they are to use:
...
For detailed subrecipe examples and implementation guides, check out our [subrecipes blog post](/blog/2025/09/15/subrecipes-in-rook) and [advanced recipe tips](https://www.youtube.com/watch?v=1szmJSKInnU) video on YouTube.
...
* **Full tool access** -- Subrecipes can use any extensions and tools available to rook.
...
Share your subagent prompts or subrecipe ideas with us on our [Discord community](https://discord.gg/rook-oss) or [GitHub discussions](https://github.com/aaif-rook/rook/discussions).



<head>
  <meta property="og:title" content="How to Choose Between Subagents and Subrecipes in rook" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://rook-docs.ai/blog/2025-09-26-subagents-vs-subrecipes" />
  ...
  <meta property="og:image" content="https://rook-docs.ai/assets/images/subrecipes-vs-subagents-19bca16b86a951e4618be8ab6ce90fb2.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="rook-docs.ai" />
  <meta name="twitter:title" content="How to Choose Between Subagents and Subrecipes in rook" />
  ...
  <meta name="twitter:image" content="https://rook-docs.ai/assets/images/subrecipes-vs-subagents-19bca16b86a951e4618be8ab6ce90fb2.png" />
</head>
