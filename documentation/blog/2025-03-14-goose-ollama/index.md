...
description: Integrate rook with Ollama for a fully local experience.
authors: 
    - tania
---

![blog cover](rookollama.png)

On the [Goosing Around](https://youtube.com/playlist?list=PLyMFt_U2IX4uFFhd_2TD9-tlJkgHMMb6F&feature=shared) stream series, host [Rizel Scarlett](https://www.linkedin.com/in/rizel-bobb-semple/) [demonstrated how to use rook locally with Ollama](https://youtube.com/watch?v=WG10r2N0IwM?feature=share) for a fully local experience on your device. Her guest, [Parth Sareen](https://www.linkedin.com/in/parthsareen/), an experienced software engineer with a focus on building frameworks and systems for AI/ML, showed us the magic of structured outputs and how rook and Ollama work together under the hood.

<!--truncate-->

rook serves as an on-machine AI agent that can interact with your applications and tools through extensions, providing the framework and interface for AI-powered workflows. Ollama enables running large language models locally with a simple API, handling the optimization of models to run efficiently on consumer hardware.
...
Before diving deep into various capabilities, Rizel walked us through how to set yourself up for success by integrating rook with Ollama. To follow along, you can [download rook](https://rook-docs.ai/) and follow a step-by-step walk through in the [Configure LLM Provider](https://rook-docs.ai/docs/getting-started/providers) guide.

If you have any questions or get stuck, feel free to chat with us on [Discord](https://discord.gg/rook-oss) or post an issue/discussion on [GitHub](https://github.com/aaif-rook/rook/). Thanks for reading!
...
Personal use cases like development assistance, personal knowledge management, education, and content management are but some examples that can benefit from working locally and offline. You can keep research and sensitive data private, and utilize rook when you have limited connectivity.
...
The benefits of owning your AI experience can be compelling for a variety of use cases. Whether you're a developer building tools, a writer working with confidential material, or simply someone who values privacy and control, I hope the rook-Ollama integration offers a glimpse into how a local experience can benefit you, and explore a future where sophisticated AI is as personal and private as the data on your hard drive. Thanks for reading!

<head>
  <meta property="og:title" content="Goosing Around: AI, But Make It Local With rook and Ollama" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://rook-docs.ai/blog/2025/03/13/rook-ollama-local" />
  <meta property="og:description" content="Integrate rook with Ollama for a fully local experience." />
  <meta property="og:image" content="http://rook-docs.ai/assets/images/rookollama-fbb2cb67117c81eaa189a6b6174e6c6c.png" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:domain" content="rook-docs.ai" />
  <meta name="twitter:title" content="Goosing Around: AI, But Make It Local With rook and Ollama" />
  <meta name="twitter:description" content="Integrate rook with Ollama for a fully local experience." />
  <meta name="twitter:image" content="http://rook-docs.ai/assets/images/rookollama-fbb2cb67117c81eaa189a6b6174e6c6c.png" />
</head>