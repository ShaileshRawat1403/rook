...
### GitHub
```
GitHub: Create a new branch called hello-world in my angiejones/rook-demo repository. Update the README.md file to say "this was written by rook" and commit it. Open a pull request with your changes.
```

To see more examples just like this, along with the results you can get, check out this [Prompt Library](https://rook-docs.ai/prompt-library)! This is your central directory for discovering and using effective prompts with Goose.
...
*To learn more about using MCP servers and Goose, check out the [Goose documentation](https://rook-docs.ai/docs/category/getting-started), or join the [Block Open Source Discord](https://discord.gg/rook-oss) to connect with other open source community members.*

<head>
  <meta property="og:title" content="MCP Explained for Non-Developers" />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://rook-docs.ai/blog/2025/04/01/mcp-nondevs" />
  ...
  <meta property="og:image" content="http://rook-docs.ai/assets/images/mcp_nondevs-5ce7f39de923cab01de6e14e5dc06744.png" />
  ...
  <meta name="twitter:image" content="http://rook-docs.ai/assets/images/mcp_nondevs-5ce7f39de923cab01de6e14e5dc06744.png" />
</head>