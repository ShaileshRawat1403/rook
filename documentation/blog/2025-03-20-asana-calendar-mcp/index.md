---
title: "How I Use rook to Plan My Week with Asana and Google Calendar MCPs"
...
Mondays are overwhelming. A pile of unfinished tasks from last week, new priorities rolling in, and meetings scattered across the calendar. It’s a lot 😩. Instead of manually sorting through my todos and figuring out where everything fits, I use a couple of handy MCP servers with rook and let it figure out my week.

<!--truncate-->

There's so many amazing MCP servers out there to make my work life better, including [Asana](https://github.com/roychri/mcp-server-asana) and [Google Calendar](https://www.pulsemcp.com/servers?q=google+calendar). I added these as rook extensions, which means Goose can now can pull in my tasks, analyze them, and schedule them, all with one simple prompt:
...
<head>
  ...
  <meta property="og:url" content="https://rook-docs.ai/blog/2025/03/20/asana-calendar-mcp" />
  <meta property="og:description" content="Use MCPs with Goose to automate task management and enhance productivity." />
  <meta property="og:image" content="http://rook-docs.ai/assets/images/mcp-planner-761303c5ddcd5c79ed853536e3f87bcf.png" />
  ...
  <meta name="twitter:image" content="http://rook-docs.ai/assets/images/mcp-planner-761303c5ddcd5c79ed853536e3f87bcf.png" />
</head>