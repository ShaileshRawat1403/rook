...
interface RookDesktopInstallerProps {
  extensionId: string;
...
export default function RookDesktopInstaller({
  extensionId,
  extensionName,
  description,
  type,
  ...
  const buildRookUrl = () => {
    ...
    return `rook://extension?${urlParts.join('&')}`;
  };
  ...
  return (
    <div>
      <ol>
        <li>
          <a href={buildRookUrl()}>Launch the installer</a>
        </li>
