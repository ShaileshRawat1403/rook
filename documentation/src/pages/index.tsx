  ...
  return (
    <section className={styles.section}>
      <div className={styles.container}>
        <h2 className={styles.sectionTitle}>What rook does</h2>
        <p className={styles.sectionSubtitle}>
          rook is a general-purpose AI agent that runs on your machine. Not
        ...
        <div className={styles.featuresGridBottom}>
          ...
          <SmallCard
            ...
            description={
              <p>
                Extensions can render interactive UIs directly inside rook
...
function WhyRookSection() {
  return (
    <section className={`${styles.section} ${styles.sectionAlt}`}>
      <div className={styles.container}>
        <h2 className={styles.sectionTitle}>Why Rook</h2>
        <p className={styles.sectionSubtitle}>
          Rook is the bird, not the chess piece. The brand is about biological
          intelligence, coordination, and agency.
        </p>
        <div className={styles.featuresGridBottom}>
          <SmallCard
            icon="🛠️"
            title="Sophisticated tool-user"
            description={
              <p>
                Rooks select and improvise tools. That maps directly to an
                active agent that chooses the right API, script, or search path
                to get work done.
              </p>
            }
          />
          <SmallCard
            ...
            description={
              <p>
                Rooks work as a colony. The product identity points to
                multi-agent coordination, scalable workflows, and parallel
                reasoning.
              </p>
            }
          />
          <SmallCard
            icon="👁️"
            title="Transparent and vigilant"
            description={
              <p>
                The bare bill and sentinel behavior map to white-box logic,
                governance, and proactive monitoring instead of opaque magic.
              </p>
            }
          />
          <SmallCard
            icon="🌱"
            title="Supportive depth"
            description={
              <p>
                Rooks forage for what is hidden. Rook should feel capable and
                precise, uncovering useful signal without feeling predatory.
              </p>
            }
          />
        </div>
    ...
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.communityGrid}>
          ...
          <a
            <a href="https://github.com/aaif-rook/rook" target="_blank" rel="noopener">
            target="_blank"
            rel="noopener"
            className={styles.communityCard}
          >
