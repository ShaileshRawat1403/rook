  ...
  return (
    <section className="w-full flex flex-col items-center gap-8 my-8">
      <div className="text-center">
        ...
        <p>Join us for livestreams, workshops, and discussions about rook and open source projects.</p>
      </div>
      ...
      <iframe
        ...
        title="Rook Community Calendar"
      />
      
      {/* Call to Action */}
      <p className="italic text-textStandard">
        Have ideas for future events? Reach out to the team on GitHub. 
